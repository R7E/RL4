...
class Rect:
    # builds a rectangle off the top left corner and computes the bottom right corner
...
def create_room(game_map, room):
    # got to the tiles in the rectangle and make them passable
    # the +1 is to account for the walls along the bottom and right side
